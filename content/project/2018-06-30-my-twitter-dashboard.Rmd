...
A searchable database of content I have retweeted as a way of bookmarking them for later. Created by following [Joseph Stachelek\'s helpful tutorial](https://jsta.rbind.io/blog/making-a-twitter-dashboard-with-r/)
...
my_table <- formatStyle(my_table, columns = 3:4, width = '10%')
my_table
