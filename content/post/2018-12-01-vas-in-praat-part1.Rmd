...
[^1]: Thanks to [Frits van Brenk](https://twitter.com/fvbrenk) via Twitter for pointing me in the direction of a the [Praat NKI TEVA app](http://www.fon.hum.uva.nl/rob/NKI_TEVA/TEVA/praat_module/TEVAexpanded.praat), which, while I didn't use directly, made me aware of the Demo Window and provided some solid working examples so I knew what to Google. 
